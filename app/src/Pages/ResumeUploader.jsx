      ...
      <div className={`app-container ${isLoading ? 'faded' : ''}`}>
        ...
        <div className="chat-container">
          <div className="input-area">
            <input className="send-button1" type="file" accept="application/pdf" onChange={handleFileChange} />
            <button className="send-button" onClick={uploadDocument}>Upload Document</button>
          </div>
          ...
          <div className="input-area">
            <input
              ...
              placeholder="Enter your interview Query"
            />
